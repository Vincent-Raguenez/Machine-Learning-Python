# -*- coding: utf-8 -*-
"""
Created on Tue Aug 29 16:22:27 2017
...
# The place holder variable that holds our data
x = tf.placeholder(tf.float32, [None, n_visible], name="x")
# The weight matrix that stores the edges weights
...
# The sample of the hidden nodes, startinf from visible state of x
...
# Whe nwe do sess.run(updt), TensorFlow will run all 3 update steps
updt = [W.assign_add(W_adder), bv.assign_add(bv_adder), bh.assign_add(bh_adder)]


### Step 4 (Final) - Run th computation graph
...
with tf.Session() as sess:
    ...
    #Now the model is fullt trained, so let's make some music!
